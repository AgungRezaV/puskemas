...
const Ciri = () => {
    ...
    return (
        <section id="ciri-ciri" className={`${styles.flexCenter} flex-col relative mx-6`}>
            <div className="flex justify-between items-center md:flex-row flex-col mb-6 relative z-[1]" data-aos="fade-left">
                <h1 className={`${styles.heading2} text-center`}>Ciri-ciri {" "}
