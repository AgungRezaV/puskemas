...
const Asupan = () => {
    ...
    return (
        <div id='asupan' className={`${styles.paragraph} bg-[#6366f1]`}>
            <div className='flex md:flex-row flex-col justify-between px-8 py-8'>
                <div className='md:px-16 px-8 md:py-0 py-8 text-white grid content-center md:text-center' data-aos='fade-right'>
                ...
                <img src={cegah_stunting} alt="dctr" className=""  />
            </div>
